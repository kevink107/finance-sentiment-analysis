...
Description:
- This program extracts sentiment scores using FinBERT on the risk factors and MD&A sections from the 10-K and 10-Q filings of the companies in the S&P 500.
'''
